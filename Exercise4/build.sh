...
g++ -std=c++14 -O3 -msse4.1 -fopenmp -o ./build/pi_seq_gcc ./src/pi/pi_seq.cpp
...
icpc -std=c++14 -O3 -xSSE4.1 -openmp -o ./build/pi_seq_icc ./src/pi/pi_seq.cpp
...
pgc++ -openmp -fastsse -std=c++11 -o ./build/pi_seq_pgi src/pi/pi_seq.cpp
